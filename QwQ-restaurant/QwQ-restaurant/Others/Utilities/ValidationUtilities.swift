...
class ValidationUtilities {
    ...
    /// Return true if open time is after close time
    static func validateAutoOpenCloseTime(autoOpenTime: TimeInterval, autoCloseTime: TimeInterval) -> Bool {
        return autoOpenTime > autoCloseTime
    }
